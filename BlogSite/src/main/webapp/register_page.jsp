...
<form action="RegisterServlet" method="POST" id="reg-form">
  ...
  <label for="userName">User Name</label>
    <input type="text" class="form-control" id="userName" name="userName" required aria-describedby="textHelp" placeholder="Enter username">
  ...
  <div class="form-group">
    ...
    <input type="password" id="exampleInputPassword1" class="form-control" required name="password" placeholder="Password">
  </div>
