...
<div class="container-fluid p-0 m-0 banner-bg">
    <div class="jumbotron primary-background text-white">
        <div class="container banner ">
            ...
            <p>A learners Home, complete Solution to all of the doubts & questionnaire within a domain. With a moto of
                serving students, teachers & public during their carrier. Guidance, motivation, inspiration, notes,
                solutions and service.</p>
            <button class=" btn btn-outline-light btn-lg"><span class="fa fa-external-link fa-spin"></span> Start
                learning now
            </button>
            <a href="login_page.jsp" class=" btn btn-outline-light btn-lg ln"><span class="fa fa-user-circle"></span>
                Login</a>
        </div>
    </div>
</div>
